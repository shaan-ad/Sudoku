...
//
// This process changes the ids below to direct your data into your own
...
// submits to the google form at this URL:
// docs.google.com/forms/d/e/1FAIpQLSdDIz-tAkX0MmydPe7c_kQly3C8eRBij3UY74LWQGTnfANH0Q/viewform
function sendNetworkLog(
    ...
    state,
    version) {
  var formid = "e/1FAIpQLSdDIz-tAkX0MmydPe7c_kQly3C8eRBij3UY74LWQGTnfANH0Q";
  var data = {
    "entry.254825423": uid,
    "entry.157976966": time,
    "entry.1327022274": name,
    "entry.1358950568": target,
    "entry.915277723": info,
    "entry.430184396": state,
    "entry.2055312572": version
  };
  var params = [];
  for (key in data) {
